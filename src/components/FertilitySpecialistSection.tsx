      ...
      <div className="maxWFull mt-4 flex flexCol itemsCenter">
        {translations.app.WhyChoiTCMPage.reasons.map((reason: Reason, index: number) => (
          <div key={index} className="mb-4 flex flexRow itemsStart justifyCenter" style={{ gap: 24 }}>
            <span className="flex itemsCenter justifyCenter textPrimary fontBlack text3xl mr-2" style={{ minWidth: 80, minHeight: 80, width: 80, height: 80, borderRadius: '50%', background: 'var(--color-secondary)', flexShrink: 0 }}>{index + 1}</span>
